...
namespace DesenvolvedorIO.Business.Core.Validations.Documentos
{
    class CpfValidacao
    {
        ...
        private static bool TemDigitosValidos(string valor)
        {
            ...
            return string.Concat(firstDigit, secondDigit) == valor.Substring(TamanhoCpf - 2, TamanhoCpf - 1);
        }
    }
    ...
    public class CnpjValidacao
    {
        ...
        private stativ bool TemDigitosValidos(string valor)
        {
            var number = valor.Substring(0, TamanhoCnpj Cnpj - 2);
            ...
            return string.Concat(firstDigit, secondDigit) == valor.Substring(TamanhoCnpj - 2, TamanhoCnpj - 1);
        }
    }
